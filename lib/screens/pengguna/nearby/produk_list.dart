...
List<Produk> wholeProduct = [
  ...
  Produk(
    ...
    nama: 'Daging Sapi Potongan Semur 500 gr',
    harga: 59000,
  ),
  Produk(
    idproduk: 7,
  ...
  Produk(
    ...
    nama: 'Sayur Brokoli Ukuran 500gr',
    harga: 1900,
  ),
  Produk(
    idproduk: 15,
